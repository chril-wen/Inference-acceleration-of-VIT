...
if __name__=='__main__':
    ...
    batch=torch.tensor([de_ids1,de_ids2],dtype=torch.long).to('cuda:0')
    print('batch:', batch.size())

    # Encoder编码
    encoder=Encoder(vocab_size=len(de_vocab),emb_size=128,q_k_size=256,v_size=512,f_size=512,head=8,nblocks=3).to('cuda:0')
